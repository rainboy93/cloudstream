...
class RoPhimProvider(val plugin: RoPhimPlugin) : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        Pair("${mainUrl}/v1/api/danh-sach/phim-bo", "Phim Bộ/vertical"),
        ...
        Pair("${mainUrl}/v1/api/danh-sach/tv-shows", "TV Shows/vertical"),
    )

    override val hasMainPage = true
    override val hasDownloadSupport = true

    var mainUrlImage = "https://img.phimapi.com/uploads/movies"
